...
3) Access the `workbench` named `agentic-codegen-vllm-test1-notebook`.
...
5) In the terminal, run `cd agentic-codegen-vllm-test1` to navigate to your sample app's directory.
